--##Commit Cria o usuário [aplicacao] na base [ORGANIZEDB02] e cria a rule [Cliente];
...
PRINT 'v2 - 001 - Criando o usuario [aplicacao].';
CREATE ROLE [Cliente] AUTHORIZATION [dbo];
PRINT 'v2 - 002 - Criando o rule [Cliente].';
ALTER ROLE [Cliente] ADD MEMBER [aplicacao];
PRINT 'v2 - 003 - Adicionado o usuario [aplicacao] a rule [Cliente].';
